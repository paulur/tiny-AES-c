...
int main(int argc, char** argv){
	...
	uint8_t* plaintext = base64_encode_entity(argv[1], -1);
    ...
    AES_CBC_decrypt_buffer(&de_ctx, plaintext, len);
    ...
    AES_CBC_encrypt_buffer(&re_ctx, plaintext, len);
